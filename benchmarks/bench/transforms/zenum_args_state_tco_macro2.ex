defmodule Bench.Transforms.ZenumArgsStateTCOMacro2 do
  ...
  defmacrop z0_from_list_next(z6_list, z5_n, z2_buffer, z0_list) do
    quote do
      case unquote(z0_list) do
        ...
        [] ->
          z0_from_list_done(unquote(z6_list), unquote(z5_n), unquote(z2_buffer), unquote(z0_list))
      end
    end
  end
